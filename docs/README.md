...
The registry is the working document. The long version is its evidence: every
row was derived from a measurement or an incident that the table has no room to
carry, and without it the rows are assertions.
