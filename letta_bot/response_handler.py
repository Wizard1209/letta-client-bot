...
# =============================================================================
def _get_next_token_new(text: str, pos: int, escaped: bool) -> tuple[str | None, int]:
...
def split_markdown_v2(
    ...
    while i < n:
        token, shift = _get_next_token_new(text, i, escaped)
        escaped = text[i] == '\\'
